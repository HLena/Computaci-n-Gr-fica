...
// añadimos dos opciones mas para el modo pan y tripode
...
static void SpecialKey ( int key, int x, int y ){
        switch(key) {
            ...
            case GLUT_KEY_HOME: //Reset Camera
                ...
                SetDependentParametersCamera( LOCAL_MyCamera );
                break;
           //Definimos campo de visión de la cámara en el modo cónico
            case GLUT_KEY_F4:
